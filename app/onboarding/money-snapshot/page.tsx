		...
		<>
			<CardHeader>
				...
				<p className="text-muted-foreground text-sm mt-1">
					Let&apos;s understand your restaurant&apos;s financial
					health to provide tailored strategies.
				</p>
			</CardHeader>
						...
						<Card className="border-blue-100 bg-blue-50/30">
							<CardContent className="pt-4 pb-2">
								<p className="text-sm text-blue-600">
									...
									opportunities for your business. All
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Your total revenue from the previous
										month
									</FormDescription>
									<FormMessage />
								</FormItem>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										The average amount customers spend per
										order
									</FormDescription>
									<FormMessage />
								</FormItem>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Cost of ingredients as a percentage of
										sales (10-90%)
									</FormDescription>
									<FormMessage />
								</FormItem>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Staff wages as a percentage of sales
										(5-60%)
									</FormDescription>
									<FormMessage />
								</FormItem>
